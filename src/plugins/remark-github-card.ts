      ...
      if (repoParts.length > 1) {
        ...
        return h('div', { class: 'github-card' }, [
          ...
          h('div', { class: 'gh-chips' }, [
            ...
            language && h('span', { class: 'gh-language' }, [{ type: 'text', value: language }]),
          ]),
        ])
      }
      ...
      // If its a user link
        ...
        return h('div', { class: 'github-card' }, [
          h('div', { class: 'gh-title' }, [
            ...
            h('a', { class: 'gh-text', href: realUrl }, [{ type: 'text', value: repoParts[0] }]),
            h('span', { class: 'gh-icon' }),
          ]),
          h('div', { class: 'gh-chips' }, [
            h('span', { class: 'gh-followers' }, [{ type: 'text', value: followers }]),
            h('span', { class: 'gh-repositories' }, [{ type: 'text', value: repositories }]),
            region && h('span', { class: 'gh-region' }, [{ type: 'text', value: region }]),
          ]),
        ])
      }

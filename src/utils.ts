...
export class TagsGroup extends PostsCollationGroup {
  ...
  // Factory method to create a PostsCollationGroup instance with async data fetching
  static async build(posts?: CollectionEntry<'posts'>[]): Promise<PostsCollationGroup> {
